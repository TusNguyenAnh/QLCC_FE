        ...
        <div className="max-w-[1400px] mx-auto py-4 px-4">
            ...
            <div className="mb-2">
                <div className="grid grid-cols-3 gap-3">
                    ...
                    {/* Item 2: Tiền dự kiến */}
                    <div
                        className="flex items-center gap-3 py-3 px-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    {/* Item 3: Tiền đã thu */}
                    <div
                        className="flex items-center gap-3 py-3 px-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 shadow-sm hover:shadow-md transition-shadow">
