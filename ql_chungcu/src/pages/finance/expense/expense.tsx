        ...
        <div className="max-w-[1400px] mx-auto py-4 px-4">
            ...
            <div className="mb-2">
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <div
                        className="flex items-center gap-3 py-3 px-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    {/* Item 2: Tiền dự kiến */}
                    <div
                        className="flex items-center gap-3 py-3 px-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    {/* Item 3: Tiền đã chi */}
                    <div
                        className="flex items-center gap-3 py-3 px-4 bg-gradient-to-br from-red-50 to-red-100 rounded-lg border border-red-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="mb-2">
                <Collapsible open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                    ...
                    <CollapsibleContent
                        className="data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-top-2 data-[state=open]:slide-in-from-top-2 transition-all duration-200">
                        <FilterExpenseForm
                            key={filterKey}
