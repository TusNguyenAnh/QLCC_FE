...
export default function LedgerExpense({
                                          open,
                                          setOpen,
                                          loading,
                                          expense,
    ...
    useEffect(() => {
        if (expense) {
            reset({
                payment_method: "cash",
                transaction_date: new Date().toISOString().split("T")[0],
                amount: expense.remaining.toString(),
                description: `Thanh toán khoản chi: ${expense.title} - ${expense.vendor}`,
                bank_transaction_id: "",
                bank_name: "",
                bank_account: "",
                payer_name: "",
            ...
            <SheetContent className="sm:max-w-[500px] flex flex-col">
                ...
                >
                    <SheetHeader>
                        ...
                        <SheetDescription>
                            Nhập thông tin ledger cho khoản chi: {expense?.title} -{" "}
                            {expense?.vendor}
                        </SheetDescription>
                    </SheetHeader>
